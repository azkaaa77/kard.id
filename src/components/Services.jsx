  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = `0 0 40px ${service.accent}15`;
      }}
      onMouseLeave2={(e) => {
    ...
    >
      {/* Top line glow */}
      <div style={{ position:'absolute', top:0, left:'50%', transform:'translateX(-50%)', width:'200px', height:'1px', background:`linear-gradient(90deg, transparent, ${service.accent}60, transparent)` }} />

      {/* Badge */}
      <div style={{ position:'absolute', top:'18px', right:'18px', background:`${service.accent}15`, border:`1px solid ${service.accent}30`, borderRadius:'100px', padding:'4px 10px', fontSize:'11px', fontWeight:'600', color:service.accent }}>
        {service.badge}
      </div>

      {/* Icon */}
      <div style={{ width:'52px', height:'52px', borderRadius:'14px', background:`${service.accent}15`, border:`1px solid ${service.accent}25`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'24px', marginBottom:'20px' }}>
        {service.icon}
      </div>

      <h3 style={{ fontSize:'clamp(18px, 2vw, 22px)', fontWeight:'700', marginBottom:'12px', letterSpacing:'-0.02em' }}>
        {service.title}
      </h3>
      ...
      <div style={{ display:'flex', flexDirection:'column', gap:'10px', marginBottom:'28px' }}>
        {service.features.map((feature) => (
          <div key={feature} style={{ display:'flex', alignItems:'center', gap:'10px' }}>
            <div style={{ width:'20px', height:'20px', borderRadius:'50%', background:`${service.accent}15`, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
      ...
      <a
        ...
        style={{ display:'inline-flex', alignItems:'center', gap:'8px', fontSize:'14px', fontWeight:'600', color:service.accent, textDecoration:'none', transition:'gap 0.2s' }}
